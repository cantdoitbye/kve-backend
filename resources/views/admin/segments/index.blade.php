...
@section('title', 'Segments - Admin Panel')
@section('page-title', 'Segments Management')

@section('content')
<div class="card">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0 fw-bold">
            <i class="fas fa-puzzle-piece me-2 text-primary"></i>All Segments
        </h5>
...
<script>
    $(document).ready(function() {
        window.dataTable = $('#segments-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.segments.index') }}",
            columns: [
